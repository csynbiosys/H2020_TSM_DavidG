function [out] = fit_to_M1_DVID(epccOutputResultFileNameBase,epcc_exps,global_theta_guess)
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%         exps_indexTest =  [2,4,18,24,13,9,20,10,12];
        ...
        for iexp=1:length(exps_indexTraining)
            ...
            y0(iexp,:) = M1_Compute_SteadyState_OverNight_DVID_v2(epcc_exps,inputs,1,global_theta_guess,...
