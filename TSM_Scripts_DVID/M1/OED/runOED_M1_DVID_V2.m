function [] = runOED_M1_DVID_V2( resultBase, numLoops, numExperiments )
...
parfor epcc_exps=1:numExperiments
        ...
        try
            ...
            [out]=OED_M1_DVID_v2(epccOutputResultFileNameBase,epccNumLoops,stepd,epcc_exps,global_theta_guess);
